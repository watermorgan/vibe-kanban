...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::scratch::StarbusNextAction::decl(),
        db::models::scratch::StarbusDecisionRequest::decl(),
        db::models::scratch::StarbusHistoryEntry::decl(),
        db::models::scratch::StarbusTaskStateData::decl(),
        db::models::scratch::StarbusGlobalStateData::decl(),
        ...
        server::routes::starbus::StarbusStateResponse::decl(),
        server::routes::starbus::StarbusIntakeRequest::decl(),
        server::routes::starbus::StarbusPreflightResponse::decl(),
        server::routes::starbus::StarbusNextActionUpdate::decl(),
        server::routes::starbus::StarbusDecisionResolveRequest::decl(),
        server::routes::starbus::StarbusTransitionRequest::decl(),
